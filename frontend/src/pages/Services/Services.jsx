...
const Services = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Services – FreelancePro</title>
        <meta
          name="description"
          content="Web development, mobile app development, UI/UX design, and more. Explore our professional digital services and start your project today."
        />
      </Helmet>
